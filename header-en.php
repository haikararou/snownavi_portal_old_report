...
<link rel="stylesheet" type="text/css" media="print" href="<?php bloginfo('template_directory'); ?>/css/pc.css">
<link href="<?php bloginfo('template_directory'); ?>/css/pc.css" rel="stylesheet" media="all and (min-width:921px)" />
<link href="<?php bloginfo('template_directory'); ?>/css/sp.css" rel="stylesheet" media="screen and (max-width:920px)" />
<link href="<?php bloginfo('template_directory'); ?>/css/sp-only.css" rel="stylesheet" media="screen and (max-width:479px)" />
<link href="<?php bloginfo('template_directory'); ?>/css/common.css" rel="stylesheet" media="all" />
<link href="<?php bloginfo('template_directory'); ?>/css/summer.css" rel="stylesheet" media="all" /><!-- 冬切替時はコメントアウト -->
...
<?php if (is_page(array('en', 'en_test'))) : ?>
