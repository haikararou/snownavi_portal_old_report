    ...
    $args=array(
        'tax_query' => array( 
            array(
				...
				'operator' => 'AND',
                'terms' => array('hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
...
<?php wp_reset_query(); ?>
	...
	<div id="pageTitle">
		<h2>Hakunori Shop & Restaurant</h2>
	</div>
	<div id="content">
		<div id="punkuz"> <a href="<?php echo home_url();?>">HOME</a> > Hakunori Shop & Restaurant </div>
<!-- /////////////カテゴリリストここから/////////////////// -->
		<ul id="tagList">
<?php
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','hakunori','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','hakunori','after_en') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                'taxonomy' => 'after', //タクソノミーを指定
                'field' => 'slug', //ターム名をスラッグで指定する
                'terms' => 'hakunori' //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
		'orderby' => 'rand',
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop07','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','hakunori') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','hakunori') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
