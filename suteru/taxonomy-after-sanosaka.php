    ...
    $args=array(
        'tax_query' => array( 
            array(
				...
				'operator' => 'AND',
                'terms' => array('sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
...
<?php wp_reset_query(); ?>
	...
	<div id="pageTitle">
		<h2>Sanosaka Shop & Restaurant</h2>
	</div>
	<div id="content">
		<div id="punkuz"> <a href="<?php echo home_url();?>">HOME</a> > Sanosaka Shop & Restaurant </div>
<!-- /////////////カテゴリリストここから/////////////////// -->
		<ul id="tagList">
<?php
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','sanosaka','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','sanosaka','after_en') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                'taxonomy' => 'after', //タクソノミーを指定
                'field' => 'slug', //ターム名をスラッグで指定する
                'terms' => 'sanosaka' //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
		'orderby' => 'rand',
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','sanosaka') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','sanosaka') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
