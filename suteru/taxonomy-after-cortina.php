    ...
    $args=array(
        'tax_query' => array( 
            array(
				...
				'operator' => 'AND',
                'terms' => array('cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
...
<?php wp_reset_query(); ?>
	...
	<div id="pageTitle">
		<h2>Cortina Shop & Restaurant</h2>
	</div>
	<div id="content">
		<div id="punkuz"> <a href="<?php echo home_url();?>">HOME</a> > Cortina Shop & Restaurant </div>
<!-- /////////////カテゴリリストここから/////////////////// -->
		<ul id="tagList">
<?php
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop07','cortina','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','cortina','after_en') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                'taxonomy' => 'after', //タクソノミーを指定
                'field' => 'slug', //ターム名をスラッグで指定する
                'terms' => 'cortina' //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
		'orderby' => 'rand',
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop07','cortina') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','cortina') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
