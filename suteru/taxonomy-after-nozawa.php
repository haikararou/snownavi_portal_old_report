    ...
    $args=array(
        'tax_query' => array( 
            array(
				...
				'operator' => 'AND',
                'terms' => array('nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
...
<?php wp_reset_query(); ?>
	...
	<div id="pageTitle">
		<h2>Nozawa Shop & Restaurant</h2>
	</div>
	<div id="content">
		<div id="punkuz"> <a href="<?php echo home_url();?>">HOME</a> > Nozawa & Restaurant </div>
<!-- /////////////カテゴリリストここから/////////////////// -->
		<ul id="tagList">
<?php
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','nozawa','after_en') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','nozawa','after_en') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop01','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop02','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop03','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop04','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop05','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
    ...
    $args=array(
        'tax_query' => array( 
            array(
                ...
                'field' => 'slug', //ターム名をスラッグで指定する
				'operator' => 'AND',
                'terms' => array('shop00','nozawa') //表示したいタームをスラッグで指定
            ),
        ),
        'post_type' => 'shop', //カスタム投稿名
        'posts_per_page'=> -1 //表示件数（-1で全ての記事を表示）
				...
				$args=array(
					'tax_query' => array( 
						array(
							...
							'field' => 'slug', //ターム名をスラッグで指定する
							'operator' => 'AND',
							'terms' => array('data','nozawa') //表示したいタームをスラッグで指定
						),
					),
					'post_type' => 'shop', //カスタム投稿名
					'posts_per_page'=> 1 //表示件数（-1で全ての記事を表示）
